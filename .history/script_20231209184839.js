const produtos = [
    ...
    { nome: "Beats Studio 3", preco: 780.00 imagem: "img/3.jpg" },
    ...
    for (const nome in carrinho.itens) {
        ...
        novoItem.innerHTML = `
            <div class="item-carrinho">
                <img src="img/${produtos.find(produto => produto.nome === nome).imagem}" alt="${nome}">
                <div>
...
function adicionarAoCarrinho(nome, preco) {
    ...
    if (carrinho.itens[nome]) {
        ...
        carrinho.itens[nome].liItem.querySelector(".quantidade").innerHTML = carrinho.itens[nome].quantidade;
        carrinho.itens[nome].liItem.querySelector(".preco-total").innerHTML = carrinho.itens[nome].precoTotal.toFixed(2);
    } else {
        carrinho.itens[nome] = {
            quantidade: 1,
            preco: preco,
