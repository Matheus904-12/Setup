...
function removeCarrinho(itemNome, itemPreco) {
    if (itensCarrinho[itemNome]) {
        ...
        itensCarrinho[itemNome].liltem.querySelector(".quantity").innerHTML = itensCarrinho[itemNome].quantity;
        itensCarrinho[itemNome].liltem.querySelector(".preco-total").innerHTML = "R$" + itensCarrinho[itemNome].precoTotal.toFixed(2);

        if (itensCarrinho[itemNome].quantity === 0) {
            itensCarrinho[itemNome].liltem.remove();
